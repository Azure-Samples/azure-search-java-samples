...
| [semantic-ranking-quickstart](./semantic-ranking-quickstart/README.md) | Extends the quickstart through modifications that invoke semantic ranking. This samples adds a semantic configuration to the index and semantic query options that formulate the query and response. |
| [vector-quickstart](./vector-quickstart/README.md) | Introduces vector search in Azure AI Search. This sample demonstrates how to create, load, and query a vector index. |
